...
-->
            ...
            <!--<div class="form-group" id="divProjectName" style="display:flex;"> -->
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control onlyAlphabetAndNumber" id="projectname" name="projectname" data-rule-required="true" placeholder="Project Name" maxlength="">
                </div>
            </div>
            <div class="form-group" id="divProjectId">
                <label for="inputprojectId" class="col-lg-2 control-label">Project ID</label>
                <div class="col-lg-10">
                    <input type="text" class="form-control onlyAlphabetAndNumber" id="projectid" name="projectid" data-rule-required="true" placeholder="Project ID" maxlength="">
                </div>
            </div>
            <div class="form-group" id="divCustomerName">
                <label for="inputCustomerName" class="col-lg-2 control-label">고객명</label>
                <div class="col-lg-10">
                    <input type="text" class="form-control" id="customername" name="customername" data-rule-required="true" placeholder="고객명" maxlength="30">
                </div>
            </div>
            <div class="form-group" id="divCustomerContact">
                <label for="inputCustomerContact" class="col-lg-2 control-label">고객 연락처</label>
                <div class="col-lg-10">
                    <input type="text" class="form-control" id="customercontact" name="customercontact" data-rule-required="true" placeholder="고객 연락처" maxlength="30">
                </div>
            </div>
            <div class="form-group" id="divCustomerPhone">
                <label for="inputCustomerPhone" class="col-lg-2 control-label">고객 번호</label>
                <div class="col-lg-10">
                    <input type="text" class="form-control onlyHangul" id="customerphone" name="customerphone" data-rule-required="true" placeholder="고객 번호" maxlength="15">
                </div>
            </div>
            ...
            <div class="form-group" id="divKepcoID">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" id="kepcoid" name="kepcoid" data-rule-required="true" placeholder="한국 전력에서 제공하는 고객번호" maxlength="15">
                </div>
            </div>
            <div class="form-group" id="divBusinessModel">
                <label for="inputBusinessModel" class="col-lg-2 control-label">해당 사업 형태</label>
                <div class="col-lg-10">
                    <input type="text" class="form-control" id="businessmodel" name="businessmodel" data-rule-required="true" placeholder="사업 유형에 따른 분류" maxlength="15">
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-lg-offset-2 col-lg-10">
                    <button type="submit" class="btn btn-default bg-primary text-white " >Submit</button>
                </div>
            </div>
