            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active"><a class="nav-link" href="#">GS Energy Monitoring System<span class="sr-only">(current)</span></a></li>
                        <li class="nav-item"><a class="nav-link" href="/monitoring">모니터링</a></li>
                        <li class="nav-item"><a class="nav-link" href="/diagram">발전현황</a></li>
                        <li class="nav-item"><a class="nav-link" href="/status">종합감시</a></li>
